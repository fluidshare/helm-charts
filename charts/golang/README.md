...
Installs a [golang](https://golang.org) image onto a Kubernetes cluster.
...
```console
# Helm
$ helm install [RELEASE_NAME] fluidshare/golang
```
...
```console
# Helm
$ helm upgrade [RELEASE_NAME] fluidshare/golang
```
